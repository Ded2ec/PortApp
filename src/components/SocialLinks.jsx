...
const socialLinks = [
  ...
  },
  {
    ...
    icon: Instagram,
    url: "https://www.instagram.com/ded2ec15229/?en=id",
    color: "#E4405F",
  ...
  },
  {
    name: "EMail",
    displayName: "Mail",
    subText: "@nontachai15229@gmail.com",
    icon: MailCheck,
    url: "mailto:nontachai15229@gmail.com",
    color: "#FF0000",
  ...
  },
  {
    name: "Line",
    displayName: "Line",
    subText: "@ノンタチャイ チャイヤウォン",
    icon: ({ className, ...props }) => (
      <img
        src="/line.png"
        alt="Line"
        width="48px" // กำหนดขนาดที่ต้องการ
        height="48px" // กำหนดขนาดที่ต้องการ
        className={className}
        {...props}
      />
    ),
    url: "https://line.me/ti/p/fvUxhem5iE",
    color: "#E4405F",
